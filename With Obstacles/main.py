...
Game(Neuron, Snake_game, SIZE, length_of_hinder, hinder_nos, STEPS_PER_GAME, EPISODES, min_len4train, epsilon, epsilon_mul_value, TO_SHOW_GAME, UPDATE_SECONDARY_WEIGHTS_NUM)
